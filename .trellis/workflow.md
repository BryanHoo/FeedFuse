...
| About to implement behavior-changing code test-first | `trellis-tdd` |
...
If the task changes runtime behavior, load `trellis-tdd` first to define the next failing test slice. Then continue with the implementation path below.
